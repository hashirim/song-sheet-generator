...
You can access the app on the [Streamlit community cloud](https://song-sheet-generator.streamlit.app/) or by downloading the github repository, installing the necessary python packages, and running `streamlit run app.py` from the terminal. 
